#!/usr/bin/env python3
"""Build or verify class vector return and cookie boundary; builds emit JSON to stdout."""
...
from src.observatory.native_lua_class_vector_return_conformance import (
    SOURCE_PINS,
    ConformanceError,
    build_conformance,
