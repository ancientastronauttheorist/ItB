#!/usr/bin/env python3
"""Build or verify conditional vector allocation composition; builds emit JSON to stdout."""
...
from src.observatory.native_vector_allocation_composition import (
    SOURCE_PINS,
    VectorAllocationCompositionError,
    build_composition,
