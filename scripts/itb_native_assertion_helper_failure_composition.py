#!/usr/bin/env python3
"""Build or verify conditional complete failure-frontier composition; builds emit JSON to stdout."""
...
from src.observatory.native_assertion_helper_failure_composition import (
    SOURCE_PINS,
    FailureCompositionError,
    build_composition,
