#!/usr/bin/env python3
"""Build or verify a private-source Lua 5.1.5 reference API experiment."""
...
from src.observatory.lua51_marker_reference import (
    ReferenceError,
    build_reference,
    validate_reference,
    validate_structure,
    ...
    try:
        if args.command == "build":
            ...
            if payload != encode_reference(evidence).encode():
                raise ReferenceError("noncanonical file encoding")
            result = (
