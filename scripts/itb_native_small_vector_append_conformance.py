#!/usr/bin/env python3
"""Build or verify integrated successful small vector append; builds emit JSON to stdout."""
...
from src.observatory.native_small_vector_append_conformance import (
    SOURCE_PINS,
    ConformanceError,
    build_conformance,
