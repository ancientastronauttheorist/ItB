#!/usr/bin/env python3
"""Build or verify bounded Lua vector allocation request semantics; builds emit JSON to stdout."""
    ...
    try:
        ...
        if args.command == "build":
            ...
            if payload != encode_semantics(evidence).encode("utf-8"):
                raise AllocationError("evidence is not deterministically encoded")
            result = (
