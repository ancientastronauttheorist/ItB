#!/usr/bin/env python3
"""Archive and seal the synthetic Firefly GetSkillEffect campaign."""
...
from src.observatory.enemy_skill_effect_callback_campaign import (  # noqa: E402
    EnemySkillEffectCallbackCampaignError,
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        receipt = build_enemy_skill_effect_callback_campaign_receipt(
            args.campaign_root,
            repository_root=args.repository_root,
        )
        path, digest = publish_enemy_skill_effect_callback_campaign_receipt(
            receipt,
            args.output,
        )
    except (
