#!/usr/bin/env python3
"""Archive and seal the synthetic Firefly GetTargetScore campaign."""
...
from src.observatory.enemy_target_score_callback_campaign import (  # noqa: E402
    EnemyTargetScoreCallbackCampaignError,
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        receipt = build_enemy_target_score_callback_campaign_receipt(
            args.campaign_root,
            repository_root=args.repository_root,
        )
        path, digest = publish_enemy_target_score_callback_campaign_receipt(
            receipt,
            args.output,
        )
    except (
