#!/usr/bin/env python3
"""Build or verify the assertion fill conformance."""
...
from src.observatory.native_assertion_helper_fill_conformance import (
    ...
    SEALED_SHA256,
    SOURCE_PINS,
    ConformanceError as Error,
    _canonical_bytes,
    _canonical_sha256,
    build_conformance as build,
    encode_conformance as encode,
    validate_conformance as validate,
    validate_structure,
)
...
def _identity(value: dict[str, Any]) -> bytes:
    if (
        ...
        raise Error("publication requires the exact sealed conformance identity")
