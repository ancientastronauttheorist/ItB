#!/usr/bin/env python3
"""Run one fixed selected-record/queued-action Observatory trial."""
...
from src.bridge.writer import bridge_observatory_selected_queue_trial  # noqa: E402
from src.observatory.selected_queue_hw import (  # noqa: E402
...
def run(args: argparse.Namespace) -> tuple[int, dict]:
    ...
    receipt = load_json_object(args.build_receipt, "selected/queue build receipt")
    ...
    try:
        ack, snapshot = bridge_observatory_selected_queue_trial(
    ...
    trial = {
        "schema_version": 1,
        "kind": "observatory_selected_queue_turn_trial",
