#!/usr/bin/env python3
"""Build or verify the native class transfer, variable byte-key class return, and caller return."""
...
from src.observatory.native_lua_class_byte_key_return_conformance import (
    SOURCE_PINS,
    ConformanceError,
    build_conformance,
