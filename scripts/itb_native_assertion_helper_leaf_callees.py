#!/usr/bin/env python3
"""Build or verify the assertion leaf callees."""
...
from src.observatory.native_assertion_helper_leaf_callees import (
    ...
    _canonical_bytes,
    _canonical_sha256,
    build_leaves as build,
    encode_leaves as encode,
    validate_leaves as validate,
    validate_structure,
)
...
def _identity(value: dict[str, Any]) -> bytes:
    if (
        ...
        raise Error("publication requires the exact sealed leaf identity")
