#!/usr/bin/env python3
"""Build or verify the first target child of the direct-callee pair receipt."""
...
from src.observatory.native_assertion_helper_first_callee_direct_callee_pair_first_target_child_static_boundary import (  # noqa: E402
    ANALYSIS_KIND,
    SCHEMA_VERSION,
    NativeAssertionHelperFirstCalleeDirectCalleePairFirstTargetChildStaticBoundaryError as Error,
    _canonical_bytes,
    build_native_assertion_helper_first_callee_direct_callee_pair_first_target_child_static_boundary as build,
    encode_native_assertion_helper_first_callee_direct_callee_pair_first_target_child_static_boundary as encode,
    validate_native_assertion_helper_first_callee_direct_callee_pair_first_target_child_static_boundary as validate,
    validate_native_assertion_helper_first_callee_direct_callee_pair_first_target_child_static_boundary_structure as validate_structure,
)
