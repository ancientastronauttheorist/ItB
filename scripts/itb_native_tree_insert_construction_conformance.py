#!/usr/bin/env python3
"""Build or verify native tree insertion construction frontier; builds emit JSON to stdout."""
...
from src.observatory.native_tree_insert_construction_conformance import (
    SOURCE_PINS,
    ConformanceError,
    build_conformance,
