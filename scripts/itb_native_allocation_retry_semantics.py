#!/usr/bin/env python3
"""Build or verify conditional allocation retry semantics; builds emit JSON to stdout."""
    ...
    try:
        ...
        if args.command == "build":
            ...
            if payload != encode_semantics(evidence).encode("utf-8"):
                raise AllocationRetryError("evidence is not deterministically encoded")
            result = (
