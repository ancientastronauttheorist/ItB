...
vector, construction, predecessor and black-parent return proofs. The next pass
adds an independent [canonical insertion model](native_tree_balancing_semantics.md),
[one red-uncle return](native_tree_recolor_return.md), and
[complete accepted canonical balancing](native_tree_balancing_conformance.md).
The native balancing corpus covers repeated recoloring, both mirrored triangles
and lines, and all four non-nil transferred-subtree cases.

[Empty hints](native_tree_empty_hint.md),
[strict minimum/end hints](native_tree_extreme_hint.md), and
[interior lower-bound hints](native_tree_interior_hint.md) now compose native
attachment/balancing through ordinary exception-registration restoration and
...
- The allocation-request helper now has 19,744 graph cases and 672 exact
