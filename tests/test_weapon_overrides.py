...
def test_override_changes_solver_plan_or_score():
    """Sanity-check the P3-7 regression gate's core invariant without
    touching the real data/weapon_overrides.json — prove that a
    non-trivial patch actually moves score or changes the plan.
    """
