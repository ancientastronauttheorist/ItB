...
import pytest
from src.observatory import native_lua_class_internal_growth_return_conformance as c

ROOT = Path(__file__).resolve().parents[1]
PROGRAMS = ROOT / "data/observatory/programs"
PREFIX = "windows_build_13725832_31fe35265598_"
CANONICAL = "28a3febc6f81de40c0a2ac69270ec3c0a4c71efe5a9f67393915f6ae3f719330"
RAW = "bc69a7964f9a4102750f2ea98541c24768750cdbb6208d8e6ac37cb8ba9b115c"
...
def receipts():
    evidence_path = PROGRAMS / (
        PREFIX + "native_lua_class_internal_growth_return_conformance.json"
    )
...
def test_modified_receipt_and_source_rejected(receipts):
    ...
    changed_sources["old_vector_return"]["schema_version"] += 1
    with pytest.raises(RuntimeError):
...
def test_exact_cli_rebuild(receipts):
    ...
    command = [
        sys.executable,
        str(
            ROOT / "scripts/itb_native_lua_class_internal_growth_return_conformance.py"
        ),
        "build",
        "--executable",
        executable,
