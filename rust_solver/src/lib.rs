...
// v392 - Legacy Mission_Tides payloads recover the source-defined current
//   Index when every visible environment marker occupies one valid lane.
//   Markerless future lanes and the permanent spawn-block boundary can then
...
// snapshot. It never fabricates the native callback time, pawn, UID, or random
// coordinate; depth-two beam expansion stops at the boundary and Python safety
// keeps it non-overridable. Pre-v406 corpus archived as
// recordings/failure_db_snapshot_sim_v405.jsonl.
...
// Rust movement now preserve that distinction. Pre-v403 corpus archived as
...
// SpiderBoss, SpiderlingEgg1, BlobberBoss, and ShamanBoss. Pre-v398 corpus archived as
...
//   objective zone, excluding decorative grass markers in shipped maps.
//   Pre-v395 corpus archived as failure_db_snapshot_sim_v394.jsonl.
...
//   recordings/failure_db_snapshot_sim_v385.jsonl.
