"""Exact short backward SIMD copy replay with a separate snapshot and ordered-access oracle."""
...
ANALYSIS_KIND = "pe_native_backward_simd_copy_conformance"
SEALED_SHA256 = "5fdeb35371c99740bacb1fed464a02bfc2df9eab7b82e1cfbd7144bf1fbfb225"
START = 0x36E580
RANGES = (
    (3597696, 3597728),
    (3598388, 3598417),
...
def vectors():
    return [
        ...
        for n in (32, 33, 34, 35, 36, 47, 48, 63, 64, 65, 95, 96, 97, 127)
        for a in range(16)
        for delta in (1, 3, 17)
        for frame in (0, 15)
...
def _build_unsealed(executable, semantics):
    from src.observatory import native_backward_simd_copy_semantics as sem
    ...
    result = dict(
        ...
        scope=dict(
            ...
            claim="Exact short backward MOVDQU path matches independent snapshot, XMM and ordered access oracles",
            premises=[
                "Explicit lengths 32 through 127 with strict higher-destination overlapping intervals",
            ...
            xmm_policy="All eight XMM registers checked; last original lowest 32 byte block replaces XMM0 and XMM1 when any full block exists; otherwise all XMM registers preserve",
            not_claimed=[
                "Forward copy, 128 byte SIMD blocks, other feature paths or overread permissions",
