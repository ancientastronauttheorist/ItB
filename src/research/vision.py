...
PROMPT_NAME_TAG = (
    ...
    "\"Firefly Leader\").\n"
    "  hp (integer): HP count shown beside the name. Use 0 if not shown.\n"
    "  move (integer|null): movement range shown. null if this is an "
    "enemy (enemies don't show move here).\n"
    "  class_icons (array of strings): names of small icons to the right "
    "of the name, from left to right (e.g. [\"damages_mountain\", "
    "\"destroys_buildings\"]). Empty array if none are visible.\n"
