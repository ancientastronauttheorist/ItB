...
9 of 70 completed. 61 remaining, sorted by global unlock % (easiest first).
...
- [x] Plus 2 more not visible in screenshot (likely Island Secure and Field Promotion -- verify)
